...
echo ""
echo "2. Show app:"
echo "   ei apps show $APP_NAMESPACE"
echo ""
echo "3. Export app (all):"
echo "   ei apps export $APP_NAMESPACE --all -o test-export.tf"
echo ""
