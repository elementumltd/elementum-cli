...
The CLI includes a type-safe GraphQL client in `internal/client/`, generated with [genqlient](https://github.com/Khan/genqlient) from the schema and operation files:
